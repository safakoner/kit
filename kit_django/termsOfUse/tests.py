...
class TermsOfUseTest(TestCase):
    ...
    def setUp(self):
        ...
        for data in PRIVACY_NOTICE:
            ...
            models.TermsOfUse.objects.create(**data)

    def test_termsOfUse(self):

        modelInstance = models.TermsOfUse.objects.get(order=PRIVACY_NOTICE[0]['order'])
